...
% 2. pick a generated code (put eveyrting in appendix if you wnat)
% 6. haskell merge sort v.s merge sort in arrow (highlight the difference => friendly user interface in haskell apdting exisitn haskell code to adpat it the framework)
% 3. the collection of local type that we derivived
...
% TODO performance code generated => measured by different algorithms
% TODO performance of tool chain => measured in the same way
